...
import com.khalil.chatapp.adapters.ChatAdapter;
import com.khalil.chatapp.databinding.ActivityChatBinding;
import com.khalil.chatapp.models.ChatMessage;
import com.khalil.chatapp.models.User;
import com.khalil.chatapp.network.ApiClient;
import com.khalil.chatapp.network.ApiService;
...
public class ChatActivity extends BaseActivity {
    ...
    private void checkForConversionRemotely(String senderId, String receiveId){
        database.collection(Constants.KEY_COLLECTION_CONVERSATION)
                .whereEqualTo(Constants.KEY_SENDER_ID, senderId)
                .whereEqualTo(Constants.KEY_RECEIVER_ID, receiveId)
                .get()
