...
import com.khalil.chatapp.adapters.RecentConversationsAdapter;
import com.khalil.chatapp.databinding.ActivityMainBinding;
import com.khalil.chatapp.listeners.ConversionListener;
...
public class MainActivity extends BaseActivity implements ConversionListener {
    ...
    private void setListeners(){
        binding.imageSignOut.setOnClickListener(view -> singOut());
        binding.fabNewShat.setOnClickListener(v ->
